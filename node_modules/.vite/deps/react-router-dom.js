...
//#endregion
//#region ../../../../node_modules/react-router/dist/development/chunk-PVWAREVJ.mjs
...
function runClientMiddlewarePipeline(args, handler) {
	...
	function errorHandler(error, routeId, nextResult) {
		if (nextResult) return Promise.resolve(Object.assign(nextResult.value, { [routeId]: {
			...
			let { matches } = args;
			let boundaryRouteId = findNearestBoundary(matches, matches[Math.min(matches.findIndex((m) => m.route.id === routeId) || 0, matches.findIndex((m) => m.unstable_shouldCallHandler()) || 0)].route.id).route.id;
...
try {
	if (isBrowser) window.__reactRouterVersion = "7.8.2";
} catch (e) {}
...
//#endregion
//#region ../../../../node_modules/react-router/dist/development/chunk-5UALIXAM.mjs
/**
* react-router v7.8.2
*
* Copyright (c) Remix Software Inc.
